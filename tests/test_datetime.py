...
class TestDateTime(unittest.TestCase):
    ...
    def test_datetime_sea_day(self):
        ...
        self.assertEqual(
            cyjpholiday.between(datetime.datetime(2020, 7, 23, 1, 1, 1), datetime.datetime(2020, 7, 23, 1, 1, 1)),
            [(datetime.date(2020, 7, 23), '海の日')]
        )
        self.assertEqual(
            cyjpholiday.between(datetime.datetime(2021, 7, 22, 1, 1, 1), datetime.datetime(2021, 7, 22, 1, 1, 1)),
    ...
    def test_datetime_mountain_day(self):
        ...
        self.assertEqual(
            cyjpholiday.between(datetime.datetime(2020, 8, 10, 1, 1, 1), datetime.datetime(2020, 8, 10, 1, 1, 1)),
            [(datetime.date(2020, 8, 10), '山の日')]
        )
        self.assertEqual(
            cyjpholiday.between(datetime.datetime(2021, 8, 8, 1, 1, 1), datetime.datetime(2021, 8, 8, 1, 1, 1)),
    ...
    def test_datetime_sports_day(self):
        ...
        self.assertEqual(
            cyjpholiday.between(datetime.datetime(2020, 7, 24, 1, 1, 1), datetime.datetime(2020, 7, 24, 1, 1, 1)),
            [(datetime.date(2020, 7, 24), 'スポーツの日')]
        )
        self.assertEqual(
            cyjpholiday.between(datetime.datetime(2021, 7, 23, 1, 1, 1), datetime.datetime(2021, 7, 23, 1, 1, 1)),
    ...
    def test_datetime_other_holiday(self):
        ...
        self.assertEqual(
            cyjpholiday.between(datetime.datetime(1959, 4, 10, 1, 1, 1), datetime.datetime(1959, 4, 10, 1, 1, 1)),
            [(datetime.date(1959, 4, 10), '皇太子・明仁親王の結婚の儀')]
        )
        self.assertEqual(
            cyjpholiday.between(datetime.datetime(1989, 2, 24, 1, 1, 1), datetime.datetime(1989, 2, 24, 1, 1, 1)),
            [(datetime.date(1989, 2, 24), '昭和天皇の大喪の礼')]
        )
        self.assertEqual(
            cyjpholiday.between(datetime.datetime(1990, 11, 12, 1, 1, 1), datetime.datetime(1990, 11, 12, 1, 1, 1)),
            [(datetime.date(1990, 11, 12), '即位の礼正殿の儀')]
        )
        self.assertEqual(
            cyjpholiday.between(datetime.datetime(1993, 6, 9, 1, 1, 1), datetime.datetime(1993, 6, 9, 1, 1, 1)),
            [(datetime.date(1993, 6, 9), '皇太子・皇太子徳仁親王の結婚の儀')]
        )
        self.assertEqual(
            cyjpholiday.between(datetime.datetime(2019, 5, 1, 1, 1, 1), datetime.datetime(2019, 5, 1, 1, 1, 1)),
            [(datetime.date(2019, 5, 1), '天皇の即位の日')]
        )
        self.assertEqual(
            cyjpholiday.between(datetime.datetime(2019, 10, 22, 1, 1, 1), datetime.datetime(2019, 10, 22, 1, 1, 1)),
