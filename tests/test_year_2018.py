...
class TestYear2018(unittest.TestCase):
    def test_holiday(self):
        ...
        self.assertEqual(cyjpholiday.is_holiday_name(dt.datetime(2018, 2, 12)), '振替休日')
        ...
        self.assertEqual(cyjpholiday.is_holiday_name(dt.datetime(2018, 4, 30)), '振替休日')
        ...
        self.assertEqual(cyjpholiday.is_holiday_name(dt.datetime(2018, 9, 24)), '振替休日')
        ...
        self.assertEqual(cyjpholiday.is_holiday_name(dt.datetime(2018, 12, 24)), '振替休日')
