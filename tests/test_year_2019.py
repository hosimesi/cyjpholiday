...
class TestYear2019(unittest.TestCase):
    def test_holiday(self):
        ...
        self.assertEqual(cyjpholiday.is_holiday_name(dt.datetime(2019, 5, 6)), 'こどもの日 振替休日')
        ...
        self.assertEqual(cyjpholiday.is_holiday_name(dt.datetime(2019, 8, 12)), '山の日 振替休日')
        ...
        self.assertEqual(cyjpholiday.is_holiday_name(dt.datetime(2019, 11, 4)), '文化の日 振替休日')
