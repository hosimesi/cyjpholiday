...
class TestYear2020(unittest.TestCase):
    def test_holiday(self):
        ...
        self.assertEqual(cyjpholiday.is_holiday_name(dt.datetime(2020, 2, 24)), '天皇誕生日 振替休日')
        ...
        self.assertEqual(cyjpholiday.is_holiday_name(dt.datetime(2020, 5, 6)), '憲法記念日 振替休日')
